...
#such as the length of the restaurant name or address
...
```{r}
# Create new features like "Has Table Booking" or 
#"Has Online Delivery" by encoding categorical variables
